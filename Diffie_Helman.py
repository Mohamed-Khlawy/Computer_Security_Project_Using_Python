...
# P = int(input ("Enter P : "))
# G = int(input(f"Enter The Primitive Root Of {P} : "))
# user_private_1 = int(input("Enter The Private Key Of User 1 : "))
# user_private_2 = int(input("Enter The Private Key Of User 2 : "))

# try:
# 	Diffie_Helman_algorithm(P, G, user_private_1, user_private_2)
